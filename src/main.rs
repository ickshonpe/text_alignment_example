...
fn setup(
    ...
    commands.spawn(Camera2dBundle {
        camera_2d: Camera2d { clear_color: bevy::core_pipeline::clear_color::ClearColorConfig::Custom(Color::BLACK) },
        ..Default::default()
    });
    commands
        .spawn(NodeBundle {
...
fn spawn_panel(parent: &mut ChildBuilder, asset_server: &Res<AssetServer>, align_items: AlignItems, justify_content: JustifyContent) {
    ...
    .with_children(|builder| {
        let items =     [
            ...
            (format!("{:?}", justify_content), Color::DARK_GREEN, Val::Px(3.))
        ];
